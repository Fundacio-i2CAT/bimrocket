...
export const translations =
{
  ...
  "tool.wms.label" : "Afegir capa WMS",
  "tool.wms.help" : "Carregar tessel·les des de Web Map Service",
  "menu.panels" : "Panells",
  "menu.help" : "Ajuda",
  ...
  "label.wfs.geometry_type" : "Tipus de geometria:",
  "option.wfs.geometry_polygon" : "Polígon",
  "option.wfs.geometry_line" : "Línia",
  "label.wfs.limit_distance" : "Distància límit:",
  "label.wfs.limit_distance_help" : "Si no hi ha IFC (IfcSite), aquest valor s'ignora i es carregarà tot el model.",
  "label.wfs.srs_name" : "SrsName:",
  "label.wfs.extrusion" : "Extrusió",

  "label.wms.provider" : "Proveïdor:",
  "label.wms.map_mode" : "Mode del mapa:",
  "label.wms.utm_zone" : "Zona UTM (0 per Global Mercator):",
  "label.wms.height_provider" : "Proveïdor per a l'altura",
  "label.wms.provider_key" : "Clau del proveïdor:",
  "label.wms.height_provider_key" : "Clau del proveïdor d'altura:",
  "option.wms.openstreetmap" : "OpenStreetMap",
  "option.wms.googlemaps" : "Google Maps",
  "option.wms.bingmaps" : "Bing Maps",
  "option.wms.mapbox" : "MapBox",
  "option.wms.heremaps" : "HERE Maps",
  "option.wms.maptiler" : "MapTiler",
  "option.wms.openmaptiles" : "OpenMapTiles",
  "option.wms.mapboxheight" : "MapBox Height",
  "option.wms.wms" : "WMS",
  "option.wms.planar" : "Pla",
  "option.wms.spherical" : "Esferic",
  "option.wms.height" : "Altura",
  "option.wms.height_shader" : "Shader d'altura",
  "option.wms.martini" : "Martini",
