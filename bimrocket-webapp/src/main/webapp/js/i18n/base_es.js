...
export const translations =
{
  ...
  "tool.wms.label" : "Añadir capa WMS",
  "tool.wms.help" : "Cargar teselas desde Web Map Service",
  "menu.panels" : "Paneles",
  "menu.help" : "Ayuda",
  ...
  "label.wfs.geometry_type" : "Tipo de geometría:",
  "option.wfs.geometry_polygon" : "Polígono",
  "option.wfs.geometry_line" : "Línea",
  "label.wfs.limit_distance" : "Distancia límite:",
  "label.wfs.limit_distance_help" : "Si no hay IFC (IfcSite), este valor se ignora y se cargará todo el modelo.",
  "label.wfs.srs_name" : "SrsName:",
  "label.wfs.extrusion" : "Extrusión",

  "label.wms.provider" : "Proveedor:",
  "label.wms.map_mode" : "Modo del mapa:",
  "label.wms.utm_zone" : "Zona UTM (0 para Global Mercator):",
  "label.wms.height_provider" : "Proveedor para la altura",
  "label.wms.provider_key" : "Clave del proveedor:",
  "label.wms.height_provider_key" : "Clave del proveedor de altura:",
  ...
  "option.wms.wms" : "WMS",
  "option.wms.planar" : "Plano",
  "option.wms.spherical" : "Esferico",
  "option.wms.height" : "Altura",
  "option.wms.height_shader" : "Shader de altura",
